...
AudioConnection          patchCord04(hal1, 0, hal2, 0);
AudioConnection          patchCord05(hal2, 0, hal3, 0);
AudioConnection          patchCord06(hal3, 0, hal4a, 0);
AudioConnection          patchCord07(hal3, 0, hal4b, 0);

AudioConnection          patchCord08(hal4a, 0, hal5a, 0);
...
// some globals
static const uint32_t DEL1LEN = 2160;
static const uint32_t DEL2LEN = 1528;
static const uint32_t DEL3LEN = 1066;
